#!/bin/bash
export semi_setting='dataset1/1_4/split_random/deeplabv3plus/self_training/resnet50/non_consistency_training/second_time'
...
--time 2 \
--consistency_training False #--plus --reliable-id-path outdir/reliable_ids/$semi_setting