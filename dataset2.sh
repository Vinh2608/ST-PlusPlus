export semi_setting='dataset2/1_4/split_random/deeplabv3plus/self_training/resnet50/non_consistency_training/first_time'
...
--save-path outdir/models/$semi_setting --time 1 --consistency_training False #--plus --reliable-id-path outdir/reliable_ids/$semi_setting