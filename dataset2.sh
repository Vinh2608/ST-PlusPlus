export semi_setting='dataset2/1_4/split_random/deeplabv3plus/self_training/resnet101/consistency_training/second_time'
python3 -W ignore main.py \
--dataset dataset2 --config configs/dataset2.yaml --data-root ./  \
--batch-size 16 --batch-size-consistency 4 --backbone resnet101 --model deeplabv3plus \
